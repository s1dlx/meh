...
Options:
  ...
  -b, --model_b TEXT
  -c, --model_c TEXT
  -m, --merging_method [weighted_sum|add_difference|weighted_subtraction|sum_twice|triple_sum|tensor_sum|euclidian_weighted_sum]
  -wc, --weights_clip
  -p, --precision INTEGER
  -o, --output_path TEXT
...
- block merge
- merging methods: `weighted_sum`, `add_difference`, `weighted_subtraction`, `sum_twice`, `triple_sum`, `tensor_sum`, `euclidian_weighted_sum`
- `fp16` and `fp32`
